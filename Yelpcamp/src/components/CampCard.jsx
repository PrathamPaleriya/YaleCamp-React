...
function CampCard({id, title, description, coverImage}) {
  return (
    <div className='border-2 border-cream m-5 p-4 rounded-md'>
      ...
      <Link to={`/home/camp/${id}`} className='border-2 border-cream px-9 py-2 w-full block text-center mt-2 rounded-lg font-semibold hover:border-cream-dark '><button>View Campground</button></Link>
